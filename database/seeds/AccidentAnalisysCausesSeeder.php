...
class AccidentAnalisysCausesSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        try
        {   
            $this->command->info('Comienza el seeder AccidentAnalisysCausesSeeder');

            $file = dirname(__FILE__) . '/data/analisysCausesAccidents.json';
            ...
            $this->command->info('Ocurrio un error al ejecutar la clase AccidentAnalisysCausesSeeder');
        }
    }
}
