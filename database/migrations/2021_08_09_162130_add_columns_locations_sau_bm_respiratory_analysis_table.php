...
class AddColumnsLocationsSauBmRespiratoryAnalysisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('sau_bm_respiratory_analysis', function (Blueprint $table) {
            $table->integer('employee_regional_id')->after('company_id')->nullable();
