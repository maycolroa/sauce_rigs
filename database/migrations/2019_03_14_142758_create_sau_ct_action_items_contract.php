...
class CreateSauCtActionItemsContract extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sau_ct_action_items_contract', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sau_ct_action_items_contract');
    }
}
