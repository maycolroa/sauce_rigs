...
class AddForeignSauCtItemTypeRatingTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::table('sau_ct_item_type_rating', function (Blueprint $table) {
            $table->dropForeign('sau_ct_item_type_rating_item_id_foreign');
            $table->dropForeign('sau_ct_item_type_rating_type_rating_id_foreign');
        });
    }
}
