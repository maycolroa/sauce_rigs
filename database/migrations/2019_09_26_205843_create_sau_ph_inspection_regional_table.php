...
class CreateSauPhInspectionRegionalTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sau_ph_inspection_regional', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sau_ph_inspection_regional');
    }
}
