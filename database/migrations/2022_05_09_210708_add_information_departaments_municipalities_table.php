...
class AddInformationDepartamentsMunicipalitiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        foreach ($departaments as $value) 
        {
            ...
            $departament->id = $value[0];
            $departament->name = $value[1];
            $departament->code = $value[2];
            $departament->save();
        }
        ...
        foreach ($municipalities as $value2) 
        {
            $municipality = new Municipality();
            $municipality->id = $value2[0];
            $municipality->departament_id = $value2[1];
            $municipality->code = $value2[2];
            $municipality->name = $value2[3];
            $municipality->save();
        }
    }
