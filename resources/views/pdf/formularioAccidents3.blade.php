    ...
    <div style="page-break-inside: avoid;">
        <table class="table-general">
            <thead>
                ...
                <tr>
                    ...
                    <td>{{$form->departamentSede}}</td>
                    <td>{{$form->ciudadSede}}</td>
        ...
        <table class="table-general">
            <thead>
                ...
                <tr>
                    <td colspan="2">{{$form->departamentCentro}}</td>
                    <td>{{$form->ciudadCentro}}</td>
    ...
    <div style="page-break-inside: avoid;">
        <table class="table-general">
            <thead>
                ...
                <tr>
                    <td>{{$form->eps ? $form->eps->name : ''}}</td>
                    <td>{{$form->afp ? $form->afp->name : ''}}</td>
                    <td>{{$form->arl ? $form->arl->name : ''}}</td> 
                    @if ($form->tiene_seguro_social == 'SI')                    
        ...
        <table class="table-general">
            <thead>
                ...
                <tr>
                    ...
                    <td>{{$form->agentAccident->name == 'Otros agentes no clasificados' ? $form->otro_agente : $form->agentAccident->name}}}</td>
                ...
                <tr>
                    <td>{{$form->siteAccident->name == 'Otro' ? $form->otro_sitio : $form->siteAccident->name}}</td>
                    <td colspan="2">{{$form->partsBody->name == 'Ubicaciones múltiples' ? $form->otra_parte : $form->partsBody->name}}</td>
                    <td colspan="2">{{$form->lesionTypes->name == 'Otro' ? $form->otra_lesion : $form->lesionTypes->name}}</td>
                </tr>
            </thead>
        </table>
    </div>
    ...
    <div style="page-break-inside: avoid;">
        <table class="table-general">
            <thead>
                ...
                <tr>
                    <td colspan="2">{{$person ? ($person->name ? $person->name : '') : ''}}</td>
