    ...
    <div style="page-break-inside: avoid;">
        <table class="table-general">
            <thead>
                ...
                <tr>
                    <th>{{ $inspections['keywords']['regional'] }}</th>
                    @if ($inspections["headquarter"])
                        <th>{{ $inspections['keywords']['headquarter'] }}</th>
                    @endif
                </tr>
                <tr>
                ...
                @if ($inspections["process"])
                    @if ($inspections["process"] && $inspections["area"])
                        <tr>
                            <th>{{ $inspections['keywords']['process'] }}</th>
                            <th>{{ $inspections['keywords']['area'] }}</th>
                        </tr>
                    @elseif ($inspections["process"] && !$inspections["area"])
                        <tr>
                            <th>{{ $inspections['keywords']['process'] }}</th>
                ...
                @if ($inspections["process"])
                    @if ($inspections["process"] && $inspections["area"])
                        <tr>
                            ...
                            <th>{{ $inspections["area"] }}</th>
                        </tr>
                    @elseif ($inspections["process"] && !$inspections["area"])
                    <tr>
                        <td>{{ $inspections["process"] }}</th>
                            @if ($inspections["compliance"])
                                <td>{{$inspections["compliance"]}}%</td>
                            @endif
                    </tr>
                ...
                @elseif (!$inspections["process"] && !$inspections["area"] && $inspections["compliance"])
                    <tr>
                        <th colspan="2">Porcentaje de cumplimiento</th>
                    </tr>
                    <tr>
