...
},
{
    ...
    fields: [
        ...
        { name: 'sau_reinc_letter_recommendations_history.to', data: 'to', title: 'Para', sortable: true, searchable: true, detail: false, key: false },
        { name: 'sau_reinc_letter_recommendations_history.from', data: 'from', title: 'De', sortable: true, searchable: true, detail: false, key: false },
