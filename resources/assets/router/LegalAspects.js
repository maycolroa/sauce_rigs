...
export default [
	{
		...
		children: [
			...
			...middleware({ 'check-permission': 'contracts_employee_u' }, [
				{
				  name: 'legalaspects-contracts-employees-switchStatus-view',
				  path: 'legalaspects/contracts/employees/switchStatus/view/:id',
				  component: () =>
					import('@/views/LegalAspects/contracts/employees/switchStatusView')
				}
			]),
			...middleware({ 'check-permission': 'contracts_employee_u' }, [
				{
			...
			...middleware({ 'check-permission': 'risksAspects_r' }, [
				{
					...
					path: 'lm/type',
					component: () =>
					import('@/views/LegalAspects/legalMatrix/types/index')
				}, 
			]),
			...middleware({ 'check-permission': 'risksAspects_c' }, [
				{
					...
					path: 'lm/type/create',
					component: () =>
					import('@/views/LegalAspects/legalMatrix/types/create')
				},
			]),
			...middleware({ 'check-permission': 'risksAspects_u' }, [
				{
					name: 'legalaspects-lm-type-edit',
					path: 'lm/type/edit/:id',
					component: () =>
