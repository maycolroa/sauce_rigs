<template>
    <div>
        <template v-if="modules.length > 0">
            ...
            <div class="row" v-if="(checkModule('riskmatrix') && checkModule('epp')) || (checkModule('dangermatrix') && checkModule('epp'))">
                <div class="col-md-5 offset-md-1" style="padding-top: 40px; padding-bottom: 20px;">
                    <hr class="border-dark mt-0 mb-4">
                </div>
            </div>
            ...
            <div class="row" v-if="checkModule('epp') && checkModule('roadsafety')">
                <div class="col-md-5 offset-md-1" style="padding-top: 40px; padding-bottom: 20px;">
                    <hr class="border-dark mt-0 mb-4">
                </div>
            </div>

            <b-row v-if="checkModule('roadsafety')">
                <b-col cols="8">
            ...
            <div class="row" v-if="checkModule('epp') || checkModule('riskmatrix') || checkModule('dangermatrix') || checkModule('dangerousconditions') || checkModule('roadSafety')">
                <div class="col-md-5 offset-md-1" style="padding-top: 40px; padding-bottom: 20px;">
                    <hr class="border-dark mt-0 mb-4">
                </div>
            </div>
