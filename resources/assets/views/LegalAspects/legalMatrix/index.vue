						...
						<div class="row no-gutters row-bordered row-border-light h-100">
							...
							<div class="d-flex col-sm-6 col-md-4 col-lg-6 align-items-center" v-if="auth.can['risksAspects_r']">
								<router-link tag="a" href="javascript:void(0)" class="card-body media align-items-center text-dark" :to="{name:'legalaspects-lm-riskaspect'}">
									...
									<span class="media-body d-block ml-3">
										...
										<br>
										<small class="text-muted">Administrar Riesgos/Aspectos Ambientales del sistema</small>
									</span>
								</router-link>
							</div>
							...
							<div class="d-flex col-sm-6 col-md-4 col-lg-6 align-items-center" v-if="auth.can['systemApply_r']">
								<router-link tag="a" href="javascript:void(0)" class="card-body media align-items-center text-dark" :to="{name:'legalaspects-lm-system-apply' }">
									...
									<span class="media-body d-block ml-3">
										<span class="text-big font-weight-bolder">Administrar Sistemas que Aplican del sistema</span>
										<br>
										<small class="text-muted">Administrar Sistemas que Aplican del sistema</small>
									</span>
								</router-link>
							</div>
							...
							<div class="d-flex col-sm-6 col-md-4 col-lg-6 align-items-center" v-if="auth.can['laws_qualify']">
								<router-link tag="a" href="javascript:void(0)" class="card-body media align-items-center text-dark" :to="{name:'legalaspects-lm-law-qualify'}">
									...
									<span class="media-body d-block ml-3">
										<span class="text-big font-weight-bolder">Calificar Normas</span>
										<br>
										<small class="text-muted">Calificar Normas segùn mis intereses</small>
									</span>
								</router-link>
							</div>

							<div class="d-flex col-sm-6 col-md-4 col-lg-6 align-items-center" v-if="auth.can['laws_report_r']">
								<router-link tag="a" href="javascript:void(0)" class="card-body media align-items-center text-dark" :to="{name:'legalaspects-lm-law-report'}">
									<i class="lnr lnr-chart-bars display-4 d-block text-primary"></i>
									<span class="media-body d-block ml-3">
										<span class="text-big font-weight-bolder">Reporte</span>
										<br>
