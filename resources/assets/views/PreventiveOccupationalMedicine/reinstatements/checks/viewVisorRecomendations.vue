...
<script>
import FormCheck from '@/components/PreventiveOccupationalMedicine/Reinstatements/Checks/FormCheckVisorRecommendationsComponent.vue'; 
import Loading from "@/components/Inputs/Loading.vue";
import Alerts from '@/utils/Alerts.js';
import GlobalMethods from '@/utils/GlobalMethods.js';

export default {
  name: 'reinstatements-checks-visor-recommendations',
  metaInfo: {
    title: 'Casos - Ver'
  },
  components:{
