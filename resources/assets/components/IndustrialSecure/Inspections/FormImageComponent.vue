<template>
    <b-form :action="url" @submit.prevent="submit" autocomplete="off">
        ...
        <b-form-row> 
            <vue-file-simple v-if="!viewOnly" class="col-md-12" @input="submit" v-model="form.image" name="image" :error="form.errorsFor('image')" placeholder="Seleccione una imagen"></vue-file-simple>
