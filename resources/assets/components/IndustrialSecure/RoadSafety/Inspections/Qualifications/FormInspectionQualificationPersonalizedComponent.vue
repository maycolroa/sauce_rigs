                              ...
                              <tbody>
                                <template v-for="(item, index2) in theme.items">
                                  <tr :key="index2">
                                    ...
                                    <td style="padding: 0px;">
                                      <vue-input :disabled="true" class="col-md-12" v-model="form.themes[index].items[index2].qualify" label="" type="text" name="qualify" placeholder="Calificación"></vue-input>
                                    </td>
                                    <td style="padding: 0px;">
