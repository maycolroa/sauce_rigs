        ...
        <b-card bg-variant="transparent" border-variant="transparent" title="" class="px-0 box-shadow-none">
          <b-row>
            ...
            <b-col md="6">
              ...
              <div v-if="row.base_type"><b>Tipo Base:</b> {{row.base_type}}</div>
              <div v-if="row.base"><b>Base:</b> <router-link :to="{ path: `audiometry/view/${row.base}` }">Ver Audiometria</router-link> </div>
