<template>
  ...
  <b-form :action="url" @submit.prevent="submit" autocomplete="off">
    <b-form-row>
      <vue-radio :checked="form.reports_opens_notify" class="col-md-12" v-model="form.reports_opens_notify" :options="siNo" name="reports_opens_notify" :error="form.errorsFor('reports_opens_notify')" label="¿Desea recibir notificación de casos con seguimiento a recomendaciones próximas a vencer?">
        </vue-radio>
