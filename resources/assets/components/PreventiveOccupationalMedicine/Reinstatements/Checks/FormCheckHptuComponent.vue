      ...
      <b-col>
        <b-card bg-variant="transparent" border-variant="dark" title="" class="mb-3 box-shadow-none">
          ...
          <div v-show="form.has_recommendations == 'SI'" class="col-md-12">
            ...
            <b-form-row>
              <vue-textarea :disabled="viewOnly" class="col-md-12" v-model="form.detail" label="Detalle Recomendaciones" name="detail" :error="form.errorsFor('detail')" placeholder=""></vue-textarea>
            </b-form-row>
          </div>
