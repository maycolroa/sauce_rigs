        ...
        <template v-for="(monitoring, index) in monitoringList">
            <div :key="monitoring.key">
                ...
                <b-form-row>
                    ...
                    <vue-radio :disabled="disabled" :checked="monitoring.has_monitoring_content" class="col-md-6" v-model="monitoring.has_monitoring_content" :options="siNo" name="has_monitoring_content_labor" label="¿Tiene seguimiento en el content?"></vue-radio>
                    <vue-input :disabled="disabled" class="col-md-6" v-model="monitoring.productivity" label="Productividad" type="number" name="productivity" ></vue-input>
                </b-form-row>
            </div>
        </template>
