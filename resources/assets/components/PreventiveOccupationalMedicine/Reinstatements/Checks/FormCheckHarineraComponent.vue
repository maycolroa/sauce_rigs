      ...
      <b-col>
        <b-card bg-variant="transparent" border-variant="dark" title="" class="mb-3 box-shadow-none">
          ...
          <div v-show="form.has_recommendations == 'SI'" class="col-md-12">
            ...
            <b-form-row v-show="form.indefinite_recommendations == 'NO'">
              <vue-advanced-select :disabled="viewOnly" class="col-md-6 offset-md-3" v-model="form.recommendations_validity" :error="form.errorsFor('recommendations_validity')" :multiple="false" :options="recommendationsValidity" :hide-selected="false" name="recommendations_validity" label="Vigencia Recomendaciones" placeholder="Seleccione una opción">
                </vue-advanced-select>
            </b-form-row>
          </div>
          ...
          <b-form-row>
            <div class="col-md-12">
              <tracing-inserter
                ...
                :si-no="siNo"
                :check-id="check.id"
                :tagsInformantRoleDataUrl="tagsInformantRoleDataUrl"
                ref="tracingInserter"
                config="harinera"
              >
              </tracing-inserter>
...
export default {
  ...
  props: {
    ...
    tagsReinstatementConditionDataUrl: { type: String, default: "" },    
    tagsInformantRoleDataUrl: { type: String, default: "" },    
