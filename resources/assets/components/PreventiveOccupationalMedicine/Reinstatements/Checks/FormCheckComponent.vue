  ...
  <b-form :action="url" @submit.prevent="submit" autocomplete="off">
    ...
    <b-row>
      <b-col>
        <b-card bg-variant="transparent" border-variant="dark" title="" class="mb-3 box-shadow-none">
          <b-form-row>
            <vue-advanced-select :disabled="viewOnly" class="col-md-6 offset-md-3" v-model="form.disease_origin" :error="form.errorsFor('disease_origin')" :multiple="false" :options="diseaseOrigins" :hide-selected="false" name="disease_origin" label="Tipo de Evento" placeholder="Seleccione una opción">
                </vue-advanced-select>
          </b-form-row>
          <b-form-row>
          ...
          <div v-show="form.has_recommendations == 'SI'" class="col-md-12">
            ...
            <b-form-row v-show="form.relocated == 'SI'">
              <vue-ajax-advanced-select class="col-md-3" v-model="form.relocated_position_id" name="relocated_position_id" label="Cargo Actualizado" placeholder="Seleccione una opción" :url="positionsDataUrl" :selected-object="form.relocated_position_multiselect">
                  </vue-ajax-advanced-select>
              <vue-ajax-advanced-select class="col-md-3" v-model="form.relocated_regional_id" name="relocated_regional_id" :label="`${keywordCheck('regional')} Actualizada`" placeholder="Seleccione una opción" :url="regionalsDataUrl" :selected-object="form.relocated_regional_multiselect">
                  </vue-ajax-advanced-select>
