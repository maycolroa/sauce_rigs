  ...
  <b-form :action="url" @submit.prevent="submit" autocomplete="off">                                  
    ...
    <b-row>
      <b-col>
        <b-card bg-variant="transparent" border-variant="dark" title="" class="mb-3 box-shadow-none">
          <b-form-row>
            <vue-advanced-select :disabled="viewOnly" class="col-md-6" v-model="form.disease_origin" :error="form.errorsFor('disease_origin')" :multiple="false" :options="diseaseOrigins" :hide-selected="false" name="disease_origin" :label="keywordCheck('disease_origin')" placeholder="Seleccione una opción">
                </vue-advanced-select>
            <vue-datepicker :disabled="viewOnly" class="col-md-6" v-model="form.disease_origin_date" label="Fecha de evento" :full-month-name="true" placeholder="Fecha de evento" :error="form.errorsFor('disease_origin_date')" name="disease_origin_date">
                </vue-datepicker>
          </b-form-row>
          <b-form-row>
