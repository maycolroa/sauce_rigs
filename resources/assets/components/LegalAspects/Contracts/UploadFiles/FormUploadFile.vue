				...
				<b-card border-variant="primary" class="mb-3 box-shadow-none">
					...
					<div v-if="form.apply_file == 'SI'">
						<b-form-row>
							...
							<vue-datepicker v-if="auth.company_id == 712" :disabled="viewOnly" class="col-md-6" v-model="form.expirationDate" label="Fecha de vencimiento" :full-month-name="true" placeholder="Seleccione la fecha de vencimiento" :error="form.errorsFor('expirationDate')" name="expirationDate" >
							</vue-datepicker>
							<vue-datepicker v-else :disabled="viewOnly" class="col-md-6" v-model="form.expirationDate" label="Fecha de vencimiento" :full-month-name="true" placeholder="Seleccione la fecha de vencimiento" :error="form.errorsFor('expirationDate')" name="expirationDate" :disabled-dates="disabledDates">
							</vue-datepicker>
						</b-form-row>
