<template>
  ...
  <b-form :action="url" @submit.prevent="submit" autocomplete="off">
    ...
    <b-form-row>
      <vue-input :disabled="viewOnly" class="col-md-6" v-model="form.age" label="Edad" type="number" name="age" :error="form.errorsFor('age')" placeholder="Edad"></vue-input>
      <vue-input :disabled="viewOnly" class="col-md-6" v-model="form.salary" label="Salario" type="number" name="salary" :error="form.errorsFor('salary')" placeholder="Salario"></vue-input>
    </b-form-row>
