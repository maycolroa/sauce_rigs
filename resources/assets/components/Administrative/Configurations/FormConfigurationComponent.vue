<template>
  ...
  <b-form :action="url" @submit.prevent="submit" autocomplete="off">
    ...
    <b-form-row v-if="auth.can['biologicalMonitoring_audiometry_r'] || auth.can['dangerMatrix_r'] || auth.can['reinc_checks_r'] || auth.can['ph_inspections_r'] || auth.can['ph_reports_r'] || auth.can['biologicalMonitoring_musculoskeletalAnalysis_r'] || auth.can['biologicalMonitoring_respiratoryAnalysis_r'] || auth.can['location_c']">
