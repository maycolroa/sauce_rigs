<template>
  ...
  <b-form :action="url" @submit.prevent="submit" autocomplete="off">
    <b-form-row>
      ...
      <vue-ajax-advanced-select v-if="auth.can['elements_r']" :disabled="viewOnly" class="col-md-12" v-model="form.elements" :error="form.errorsFor('elements')"  name="elements" label="ELementos de protección personal correspondientes al cargo" placeholder="Seleccione los elementos" :url="tagsElementsDataUrl" :multiple="true" :allowEmpty="true" :selected-object="form.multiselect_elements">
