...
return [
    ...
    */
    ...
    'attributes'           => [
      ...
      'objectives.*.subobjectives' => 'Subtemas',
      ...
      'items.*' => 'Calificación',
      'days_alert_expiration_date_action_plan' => 'Días de alerta',
      'types_rating' => 'Proceso a evaluar',
      ...
      'system_apply' => 'Sistema que aplica',
      ...
      'themes.*.description' => 'Descripción',
      'themes.*.items.*.show_program_value' => 'Mostrar Valor Programado',
      'documents' => 'Documentos',
      'year' => 'Año',
      'month' => 'Mes',
      'social_security_working_day' => 'Dia habil seguridad social',
      'activities.*.documents.*.files.*.required expiration date' => 'Requiere fecha de vencimiento',
      'rate' => 'Severidad',
      ...
      'subprocesses.*.sub_process_id' => 'Subproceso',
      'subprocesses.*.risks.*.risk_id' => 'Riesgo',
      'subprocesses.*.risks.*.economic' => 'Económico',
      'subprocesses.*.risks.*.quality_care_patient_safety' => 'Calidad en la atención y seguridad del paciente',
      'subprocesses.*.risks.*.reputational' => 'Reputacional',
      'subprocesses.*.risks.*.legal_regulatory' => 'Legal Regulatorio',
      'subprocesses.*.risks.*.environmental' => 'Ambiental',
      'subprocesses.*.risks.*.max_inherent_impact' => 'Max. Impacto Inherente',
      'subprocesses.*.risks.*.description_inherent_impact' => 'Descripción Impacto Inherente',
      'subprocesses.*.risks.*.max_inherent_frequency' => 'Max. Frecuencia Inherente',
      'subprocesses.*.risks.*.description_inherent_frequency' => 'Descripicón Frecuencia Inherente',
      'subprocesses.*.risks.*.inherent_exposition' => 'Exposición Inherente',
      'subprocesses.*.risks.*.controls_decrease' => 'Los controles apuntan a disminuir',
      'subprocesses.*.risks.*.nature' => 'Naturaleza',
      'subprocesses.*.risks.*.evidence' => 'Evidencia',
      'subprocesses.*.risks.*.coverage' => 'Cobertura',
      'subprocesses.*.risks.*.documentation' => 'Documentación',
      'subprocesses.*.risks.*.segregation' => 'Segregación',
      'subprocesses.*.risks.*.control_evaluation' => 'Evaluación del control',
      'subprocesses.*.risks.*.percentege_mitigation' => '% Mitigación',
      'subprocesses.*.risks.*.max_residual_impact' => 'Max. Impacto Residual',
      'subprocesses.*.risks.*.description_residual_impact' => 'Descripción Impacto Residual',
      ...
      'plate' => 'Placa',
      'name_propietary' => 'Nombre del propietario',
      'registration_number' => 'Número de matricula',
      'registration_number_date' => 'Fecha de expedición de matrícula',
      'type_vehicle' => 'Tipo de vehiculo',
      'code_vehicle' => 'Codigo del vehiculo',
      'mark' => 'Marca',
      'line' => 'Linea',
      'model' => 'modelo',
      'cylinder_capacity' => 'Cilindraje',
      'color' => 'Color',
      ...
      'state' => 'Estado',
      'soat_number' => 'Número del SOAT',
      'insurance' => 'Aseguradora',
      'expedition_date_soat' => 'Fecha de expedición',
      'due_date_soat' => 'Fecha de vencimiento',
      'mechanical_tech_number' => 'Número del Tecno mecánica',
      'issuing_entity' => 'Entidad que expide',
      'expedition_date_mechanical_tech' => 'Fecha de expedición',
      'due_date_mechanical_tech' => 'Fecha de vencimiento',
