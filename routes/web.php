...
Route::get('/password/helperRecuperate', 'Auth\ForgotPasswordController@showLinkRequestHelper');
...
Route::middleware(['auth'])->group(function () { 
    ...
    Route::prefix('selects')->group(function () {
        ...
        Route::prefix('industrialSecurity')->group(function () {
          ...
          Route::post('inspectionTypeItems', 'IndustrialSecure\DangerousConditions\Inspections\InspectionController@multiselectTypesItems');
        });
...
////////
      ...
      Route::post('accidents/emailPdf/{accident}', 'IndustrialSecure\AccidentsWork\AccidentsWorkController@downloadEmail');
      ...
      Route::post('fileUpload/reportEmployeeContracts', 'LegalAspects\Contracs\FileUploadController@reportEmployeeFiles');
      ...
      Route::get('trainingContract/downloadPdf/{id}', 'LegalAspects\Contracs\TrainingEmployeeController@downloadPdf');
      ...
      Route::post('employeeContract/reportDocumentCloseToWinning', 'LegalAspects\Contracs\ContractEmployeeController@reportDocumentCloseToWinning');
      Route::post('employeeContract/globalDocumentCloseToWinning', 'LegalAspects\Contracs\ContractEmployeeController@globalDocumentCloseToWinning');
