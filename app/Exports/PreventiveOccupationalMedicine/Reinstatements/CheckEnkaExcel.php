    ...
    */
    ...
    public function map($data): array
    {
      ...
      return [
        ...
        $data->laterality,
        $data->disease_origin_recomendations,
        ...
        $data->laterality_2,
        $data->disease_origin_recomendations_2,
        ...
        $data->laterality_3,
        $data->disease_origin_recomendations_3,
    ...
    public function headings(): array
    {
      return [
        ...
        'Categoría (2)',
        'Lateralidad (2)',
        'Recomendaciones CIE10 (2)',
        'Código CIE10 (3)',
        'Descripción CIE10 (3)',
        'Sistema (3)',
        'Categoría (3)',
        'Lateralidad (3)',
        'Recomendaciones CIE10 (3)',
