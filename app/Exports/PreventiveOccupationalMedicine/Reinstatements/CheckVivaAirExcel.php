...
class CheckVivaAirExcel implements FromCollection, WithHeadings, WithMapping, WithColumnFormatting, WithEvents, WithTitle, ShouldAutoSize
{
    ...
    */
    ...
    public function headings(): array
    {
      return [
        ...
        'Categoría',
        'SVE Asociado',
        'Certificado médico UEAC - (Licencia / Permiso de Vuelo)',
        'Lateralidad',
