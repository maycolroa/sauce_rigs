...
class RiskMatrixImportTemplate implements FromCollection, WithHeadings, WithMapping, WithEvents, WithTitle, ShouldAutoSize
{
    ...
    */
    ...
    public function headings(): array
    {
      ...
      $columns = array_merge($columns, [
        'Secuencia Riesgo (Debe repetirse la cantidad de causas que ingrese por cada riesgo)',
        'Nomenclatura',
        'Participantes (Separados por “,”)',
        'Sub-Proceso',
        'Evento de Riesgo',
        'Categoría del Riesgo (Tomar el valor de la pestaña Categorias de Riesgo)',
        'Causa',
