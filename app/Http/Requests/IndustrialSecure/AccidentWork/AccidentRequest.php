...
class AccidentRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules = [
            ...
            'identificacion_sede_principal' => 'required|string',
            'direccion_sede_principal' => 'required|string',
            'telefono_sede_principal' => 'required|string',
            'email_sede_principal' => 'required|email',
            'departamento_sede_principal_id' => 'required|string',
            'ciudad_sede_principal_id' => 'required|string',
