...
class AudiometryRequest extends FormRequest
{
    ...
    public function rules()
    {
      ...
      return [
            ...
            'osseous_left_500' => "nullable|in:$NUMBERS_AVAILABLE_RESULTS|integer|digits_between:0,120",
            'osseous_left_1000' => "nullable|in:$NUMBERS_AVAILABLE_RESULTS|integer|digits_between:0,120",
            'osseous_left_2000' => "nullable|in:$NUMBERS_AVAILABLE_RESULTS|integer|digits_between:0,120",
            'osseous_left_3000' => "nullable|in:$NUMBERS_AVAILABLE_RESULTS|integer|digits_between:0,120",
            'osseous_left_4000' => "nullable|in:$NUMBERS_AVAILABLE_RESULTS|integer|digits_between:0,120",
            'osseous_right_500' => "nullable|in:$NUMBERS_AVAILABLE_RESULTS|integer|digits_between:0,120",
            'osseous_right_1000' => "nullable|in:$NUMBERS_AVAILABLE_RESULTS|integer|digits_between:0,120",
            'osseous_right_2000' => "nullable|in:$NUMBERS_AVAILABLE_RESULTS|integer|digits_between:0,120",
            'osseous_right_3000' => "nullable|in:$NUMBERS_AVAILABLE_RESULTS|integer|digits_between:0,120",
            'osseous_right_4000' => "nullable|in:$NUMBERS_AVAILABLE_RESULTS|integer|digits_between:0,120",
