...
{ 
    ...
    public function multiselect(Request $request)
    {
        if($request->has('keyword'))
        {
            ...
            $cie10 = Cie11Code::selectRaw("
                    sau_reinc_cie11_codes.id as id,
                    CONCAT(sau_reinc_cie11_codes.code, ' - ', sau_reinc_cie11_codes.description) as description
                ")
