    ...
    */
    ...
    public function store(VehicleRequest $request)
    {
        ...
        try
        {
            ...
            $vehicle->registration_number_date = (Carbon::createFromFormat('D M d Y', $request->registration_number_date))->format('Y-m-d');
            ...
            $vehicle->expedition_date_soat = (Carbon::createFromFormat('D M d Y', $request->expedition_date_soat))->format('Y-m-d');
            $vehicle->due_date_soat =  (Carbon::createFromFormat('D M d Y', $request->due_date_soat))->format('Y-m-d');
            ...
            $vehicle->expedition_date_mechanical_tech = (Carbon::createFromFormat('D M d Y', $request->expedition_date_mechanical_tech))->format('Y-m-d');
            $vehicle->due_date_mechanical_tech = (Carbon::createFromFormat('D M d Y', $request->due_date_mechanical_tech))->format('Y-m-d');
            ...
            $vehicle->expedition_date_policy = (Carbon::createFromFormat('D M d Y', $request->expedition_date_policy))->format('Y-m-d');;
            $vehicle->due_date_policy = (Carbon::createFromFormat('D M d Y', $request->due_date_policy))->format('Y-m-d');
    ...
    public function show($id)
    {
        try
        {
            ...
            $vehicle->registration_number_date = (Carbon::createFromFormat('Y-m-d', $vehicle->registration_number_date))->format('D M d Y');
            $vehicle->expedition_date_soat = (Carbon::createFromFormat('Y-m-d', $vehicle->expedition_date_soat))->format('D M d Y');
            $vehicle->due_date_soat = (Carbon::createFromFormat('Y-m-d', $vehicle->due_date_soat))->format('D M d Y');
            $vehicle->expedition_date_mechanical_tech = (Carbon::createFromFormat('Y-m-d', $vehicle->expedition_date_mechanical_tech))->format('D M d Y');
            $vehicle->due_date_mechanical_tech = (Carbon::createFromFormat('Y-m-d', $vehicle->due_date_mechanical_tech))->format('D M d Y');
            $vehicle->expedition_date_policy = (Carbon::createFromFormat('Y-m-d', $vehicle->expedition_date_policy))->format('D M d Y');
            $vehicle->due_date_policy = (Carbon::createFromFormat('Y-m-d', $vehicle->due_date_policy))->format('D M d Y');
    ...
    public function update(VehicleRequest $request, Vehicle $vehicle)
    {
        ...
        try
        {
            ...
            $vehicle->expedition_date_policy = (Carbon::createFromFormat('D M d Y', $request->expedition_date_policy))->format('Y-m-d');;
            $vehicle->due_date_policy = (Carbon::createFromFormat('D M d Y', $request->due_date_policy))->format('Y-m-d');
            $vehicle->file_policy = $request->file_policy;
