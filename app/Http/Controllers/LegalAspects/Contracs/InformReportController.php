...
class InformReportController extends Controller
{
    ...
    public function reportTableTotalesPorcentage2(Request $request)
    {
        $themes = collect([]);
        ...
        foreach ($themes as $key => $theme) 
        {
            ...
            $qualifications_2 = [
                'item' => 'Total',
                'month0' => $qualifications->sum('month0') > 0 ? (round($qualifications->sum('month0')/($qualifications->count() > 0 ? round($qualifications->count(), 2) : 1), 2)) : 0,
                'month1' => $qualifications->sum('month1') > 0 ? (round($qualifications->sum('month1')/($qualifications->count() > 0 ? $qualifications->count() : 1), 2)) : 0,
                'month2' => $qualifications->sum('month2') > 0 ? (round($qualifications->sum('month2')/($qualifications->count() > 0 ? round($qualifications->count(), 2) : 1), 2)) : 0,
                'month3' => $qualifications->sum('month3') > 0 ? (round($qualifications->sum('month3')/($qualifications->count() > 0 ? round($qualifications->count(), 2) : 1), 2)) : 0,
                'month4' => $qualifications->sum('month4') > 0 ? (round($qualifications->sum('month4')/($qualifications->count() > 0 ? round($qualifications->count(), 2) : 1), 2)) : 0,
                'month5' => $qualifications->sum('month5') > 0 ? (round($qualifications->sum('month5')/($qualifications->count() > 0 ? round($qualifications->count(), 2) : 1), 2)) : 0,
                'month6' => $qualifications->sum('month6') > 0 ? (round($qualifications->sum('month6')/($qualifications->count() > 0 ? round($qualifications->count(), 2) : 1), 2)) : 0,
                'month7' => $qualifications->sum('month7') > 0 ? (round($qualifications->sum('month7')/($qualifications->count() > 0 ? round($qualifications->count(), 2) : 1), 2)) : 0,
                'month8' => $qualifications->sum('month8') > 0 ? (round($qualifications->sum('month8')/($qualifications->count() > 0 ? round($qualifications->count(), 2) : 1), 2)) : 0,
                'month9' => $qualifications->sum('month9') > 0 ? (round($qualifications->sum('month9')/($qualifications->count() > 0 ? round($qualifications->count(), 2) : 1), 2)) : 0,
                'month10' => $qualifications->sum('month10') > 0 ? (round($qualifications->sum('month10')/($qualifications->count() > 0 ? round($qualifications->count(), 2) : 1), 2)) : 0,
                'month11' => $qualifications->sum('month11') > 0 ? (round($qualifications->sum('month11')/($qualifications->count() > 0 ? round($qualifications->count(), 2) : 1), 2)) : 0,
                'total' => $qualifications->sum('total') > 0 ? (round($qualifications->sum('total')/round($qualifications->count(), 2), 1)) : 0,
            ];
    ...
    public function reportTableTotalesContractsPorcentage(Request $request)
    {
        ...
        foreach ($themes as $key => $theme) 
        {
            ...
            $qualifications_2 = [
                'item' => 'Total',
                'month0' => $qualification_global->sum('month0') > 0 ? (round(round($qualification_global->sum('month0'), 2)/($qualification_global->count() > 0 ? round($qualification_global->count(), 2) : 1), 2)) : 0,
                'month1' => $qualification_global->sum('month1') > 0 ? (round(round($qualification_global->sum('month1'), 2)/($qualification_global->count() > 0 ? round($qualification_global->count(), 2) : 1), 2)) : 0,
                'month2' => $qualification_global->sum('month2') > 0 ? (round(round($qualification_global->sum('month2'), 2)/($qualification_global->count() > 0 ? round($qualification_global->count(), 2) : 1), 2)) : 0,
                'month3' => $qualification_global->sum('month3') > 0 ? (round(round($qualification_global->sum('month3'), 2)/($qualification_global->count() > 0 ? round($qualification_global->count(), 2) : 1), 2)) : 0,
                'month4' => $qualification_global->sum('month4') > 0 ? (round(round($qualification_global->sum('month4'), 2)/($qualification_global->count() > 0 ? round($qualification_global->count(), 2) : 1), 2)) : 0,
                'month5' => $qualification_global->sum('month5') > 0 ? (round(round($qualification_global->sum('month5'), 2)/($qualification_global->count() > 0 ? round($qualification_global->count(), 2) : 1), 2)) : 0,
                'month6' => $qualification_global->sum('month6') > 0 ? (round(round($qualification_global->sum('month6'), 2)/($qualification_global->count() > 0 ? round($qualification_global->count(), 2) : 1), 2)) : 0,
                'month7' => $qualification_global->sum('month7') > 0 ? (round(round($qualification_global->sum('month7'), 2)/($qualification_global->count() > 0 ? round($qualification_global->count(), 2) : 1), 2)) : 0,
                'month8' => $qualification_global->sum('month8') > 0 ? (round(round($qualification_global->sum('month8'), 2)/($qualification_global->count() > 0 ? round($qualification_global->count(), 2) : 1), 2)) : 0,
                'month9' => $qualification_global->sum('month9') > 0 ? (round(round($qualification_global->sum('month9'), 2)/($qualification_global->count() > 0 ? round($qualification_global->count(), 2) : 1), 2)) : 0,
                'month10' => $qualification_global->sum('month10') > 0 ? (round(round($qualification_global->sum('month10'), 2)/($qualification_global->count() > 0 ? round($qualification_global->count(), 2) : 1), 2)) : 0,
                'month11' => $qualification_global->sum('month11') > 0 ? (round(round($qualification_global->sum('month11'), 2)/($qualification_global->count() > 0 ? round($qualification_global->count(), 2) : 1), 2)) : 0,
    ...
    public function reportTableTotalesPorcentage(Request $request)
    {
        ...
        foreach ($themes as $key => $theme) 
        {
            ...
            if (isset($request->consult_all) && $request->consult_all == 'NO' && $request->contract_id)
                $total->where('contract_id', $request->contract_id);
