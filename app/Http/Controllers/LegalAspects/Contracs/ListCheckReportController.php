...
class ListCheckReportController extends Controller
{
    ...
    public function data(Request $request)
    {
        ...
        $informManager = new InformManagerListCheck($this->company, /*$identifications, $names, $regionals, $businesses, $diseaseOrigin, $nextFollowDays, $dates, $years, $sveAssociateds, $medicalCertificates, $relocatedTypes, $filtersType*/);
