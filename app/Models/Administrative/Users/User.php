...
class User extends Authenticatable
{
    ...
    protected $fillable = [
        'name', 'email', 'password','active', 'state', 'document', 'document_type', 'default_module_url', 'module_id', 'last_login_at', 'created_at', 'updated_at', 'medical_record', 'sst_license', 'terms_conditions', 'firm', 'code_login', 'validate_login'
    ];
