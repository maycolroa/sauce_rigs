...
use App\Imports\PreventiveOccupationalMedicine\Reinstatements\LetterImport;
use App\Models\General\LogFilesImport;

class LetterImportJob implements ShouldQueue
{
    ...
    {
      $this->nameFile = 'carta_recomendaciones_'.date("YmdHis").'.xlsx';
      ...
      $recordImport->module = "Cartas de recomendaciones";
      $recordImport->save();
    }
    ...
    {
      Excel::import(new LetterImport($this->company_id, $this->user), "/import/1/$this->nameFile", 'public');
