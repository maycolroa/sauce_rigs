...
use App\Imports\Administrative\Positions\PositionImport;
use App\Models\General\LogFilesImport;

class PositionImportJob implements ShouldQueue
{
    ...
    {
      Excel::import(new PositionImport($this->company_id, $this->user), "/import/1/$this->nameFile", 'public');
