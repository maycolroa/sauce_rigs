...
namespace App\Jobs\Administrative\Employees;
...
use App\Imports\Administrative\Employees\EmployeeImportInactive;
use App\Models\General\LogFilesImport;

class EmployeeImportInactiveJob implements ShouldQueue
{
    ...
    {
      Excel::import(new EmployeeImportInactive($this->company_id, $this->user), "/import/1/$this->nameFile", 'public');
