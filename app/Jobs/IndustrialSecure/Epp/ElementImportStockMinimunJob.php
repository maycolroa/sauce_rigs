...
use App\Imports\IndustrialSecure\Epp\ElementStockMinimunImport;
use App\Models\General\LogFilesImport;

class ElementImportStockMinimunJob implements ShouldQueue
{
    ...
    {
      $this->nameFile = 'elementos_stock_minimo_'.date("YmdHis").'.xlsx';
      ...
      $recordImport->module = "Epp Stock Minimo";
      $recordImport->save();
    }
    ...
    {
      Excel::import(new ElementStockMinimunImport($this->company_id, $this->user), "/import/1/$this->nameFile", 'public');
