...
use App\Imports\IndustrialSecure\Epp\ElementImport;
use App\Models\General\LogFilesImport;

class ElementImportJob implements ShouldQueue
{
    ...
    {
      $this->nameFile = 'elementos_'.date("YmdHis").'.xlsx';
      ...
      $recordImport->module = "Epp Elementos";
      $recordImport->save();
    }
    ...
    {
      Excel::import(new ElementImport($this->company_id, $this->user), "/import/1/$this->nameFile", 'public');
